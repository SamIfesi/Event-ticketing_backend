...
$router->post('/api/events',          [EventController::class, 'store'],    [AuthMiddleware::class, RoleMiddleware::class => ['organizer', 'admin', 'dev']]);
$router->put('/api/events/:id',      [EventController::class, 'update'],   [AuthMiddleware::class, RoleMiddleware::class => ['organizer', 'admin', 'dev']]);
